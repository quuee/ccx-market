...
public class TokenAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (authorization == null || !authorization.startsWith(properties.getBearer())) {
        ...
        String token = authorization.replace(properties.getBearer(), "");
        Date expiration = jwtUtils.getTokenBody(token.trim()).getExpiration();

package com.ccx.market.aspect.weblog;

import com.alibaba.fastjson.JSON;
import com.ccx.market.util.IPUtil;
import com.ccx.market.util.StackTraceUtil;
...
public class SysLogAspect {
    ...
    */
    @Pointcut("execution(public * com.ccx.*.web.controller..*.*(..))")
